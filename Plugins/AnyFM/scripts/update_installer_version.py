...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=AnyFM Demo Installer\n"
      else:
        line="OutputBaseFilename=AnyFM Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the AnyFM Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the AnyFM installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=AnyFM Demo installer\n"
     else:
       line="SetupWindowTitle=AnyFM installer\n"
