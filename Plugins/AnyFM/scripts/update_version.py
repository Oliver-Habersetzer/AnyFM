...
def main():
  ...
  plistpath = scriptpath + "/resources/AnyFM-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AnyFM-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AnyFM-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AnyFM-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AnyFM-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/AnyFM.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AnyFM.iss",inplace=1):
